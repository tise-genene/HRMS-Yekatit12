                                            ...
                                            <div class="row ">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input placeholder="Please insert only characters and spaces" type="text" name="department" id="firstName" value="<?php  echo $editdepartment->dep_name;?>" class="form-control" placeholder="">
